...
def one_run(n, level):
    ...
    X_base = int(probe_r1["body"].get("marker_seen") is True)  # per-route probe via router1 alone
    ...
    r2_succeeded = probe_r2_post["status"] == 200 and probe_r2_post["body"].get("marker_seen") is True
